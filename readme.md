...
| **MPU**                     |mikroprocesing unit                 | Samostatný procesor vyžadující externí RAM a úložiště, zpravidla běží plnohodnotný OS (Linux)        |                                             |                                          |
| **Embedded**             |       vestavěny system              |                                                                                                      | Embedded PLC, Embedded PC                   | Bílá technika, bankomaty, regulace kotlů |
| **PLC**                  |programmate logic controller         | Průmyslový automat pro cyklické deterministické řízení procesů, vysoká odolnost, modulární/kompaktní |                                             |                                          |
| **iPC**                  |         industrial pc                 |                                                                                                      |                                             |                                          |
